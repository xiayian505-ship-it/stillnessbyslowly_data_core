 ...
 *
 * IMPORTANT ABOUT GENERATION
 * --------------------------
 * 本檔案的可讀結構由程式化整理產生；產生時使用執行環境的 ICU Chinese Calendar
 * 作為結構化輔助。資料可信度與最終取捨仍以 lunar_reference.txt 所列的
 * CWA / HKO 官方資料與驗證規則為準。若本檔與官方來源發生差異，應更新本檔，
 * 不得修改 reference 來迎合程式結果。
 *
 * 邊界說明：為了讓未來 lunar.js 能處理 1901-01-01 起始日，下面另外保留
...
(function (root) {
  ...
  const LunarData = {
    ...
    1917: {
      ...
      months: [
        ...
        { month: 3, isLeap: false, days: 29, start: "1917-03-23" }, // 三月
        { month: 3, isLeap: true, days: 30, start: "1917-04-21" }, // 閏三月
    ...
    1922: {
      ...
      months: [
        ...
        { month: 6, isLeap: false, days: 29, start: "1922-06-25" }, // 六月
        { month: 6, isLeap: true, days: 30, start: "1922-07-24" }, // 閏六月
    ...
    1933: {
      ...
      months: [
        ...
        { month: 5, isLeap: true, days: 30, start: "1933-06-23" }, // 閏五月
        { month: 6, isLeap: false, days: 29, start: "1933-07-23" }, // 六月
    ...
    1953: {
      ...
      months: [
        ...
        { month: 12, isLeap: false, days: 30, start: "1954-01-05" }, // 十二月
      ]
    },

    1954: {
      newYear: "1954-02-04", // 農曆正月初一
      leapMonth: 0, // 無閏月
      months: [
        { month: 1, isLeap: false, days: 29, start: "1954-02-04" }, // 正月
    ...
    1955: {
      ...
      leapMonth: 3, // 閏三月
      months: [
        { month: 1, isLeap: false, days: 30, start: "1955-01-24" }, // 正月
        { month: 2, isLeap: false, days: 29, start: "1955-02-23" }, // 二月
    ...
    1987: {
      ...
      months: [
        ...
        { month: 7, isLeap: false, days: 29, start: "1987-07-26" }, // 七月
        { month: 7, isLeap: true, days: 30, start: "1987-08-24" }, // 閏七月
    ...
    1996: {
      ...
      months: [
        ...
        { month: 5, isLeap: false, days: 30, start: "1996-06-16" }, // 五月
        { month: 6, isLeap: false, days: 29, start: "1996-07-16" }, // 六月
        { month: 7, isLeap: false, days: 30, start: "1996-08-14" }, // 七月
        { month: 8, isLeap: false, days: 29, start: "1996-09-13" }, // 八月
    ...
    1998: {
      ...
      months: [
        ...
        { month: 11, isLeap: false, days: 30, start: "1998-12-19" }, // 十一月
        { month: 12, isLeap: false, days: 29, start: "1999-01-18" }, // 十二月
      ]
    },
    ...
    2012: {
      ...
      months: [
        ...
        { month: 6, isLeap: false, days: 30, start: "2012-07-19" }, // 六月
        { month: 7, isLeap: false, days: 29, start: "2012-08-18" }, // 七月
    ...
    2018: {
      ...
      months: [
        ...
        { month: 9, isLeap: false, days: 29, start: "2018-10-09" }, // 九月
        { month: 10, isLeap: false, days: 30, start: "2018-11-07" }, // 十月
    ...
    2026: {
      ...
      months: [
        ...
        { month: 12, isLeap: false, days: 30, start: "2027-01-08" }, // 十二月
      ]
    },

    2027: {
      newYear: "2027-02-07", // 農曆正月初一
      leapMonth: 0, // 無閏月
      months: [
        { month: 1, isLeap: false, days: 29, start: "2027-02-07" }, // 正月
    ...
    2029: {
      ...
      months: [
        ...
        { month: 12, isLeap: false, days: 29, start: "2030-01-04" }, // 十二月
      ]
    },

    2030: {
      newYear: "2030-02-02", // 農曆正月初一
      leapMonth: 0, // 無閏月
      months: [
        { month: 1, isLeap: false, days: 30, start: "2030-02-02" }, // 正月
    ...
    2060: {
      ...
      months: [
        ...
        { month: 3, isLeap: false, days: 29, start: "2060-04-01" }, // 三月
        { month: 4, isLeap: false, days: 30, start: "2060-04-30" }, // 四月
    ...
    2070: {
      ...
      leapMonth: 0, // 無閏月
      months: [
        { month: 1, isLeap: false, days: 30, start: "2070-02-11" }, // 正月
        { month: 2, isLeap: false, days: 29, start: "2070-03-13" }, // 二月
  ...
  // 公開為唯讀慣例資料物件；真正的查詢與轉換 API 由未來 lunar.js 負責。
